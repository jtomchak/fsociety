...
function integrateWasmJS() {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'fsociety-4d51b9aea2a97326.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'fsociety-4d51b9aea2a97326.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'fsociety-4d51b9aea2a97326.temp.asm.js';
...
var real__fact = asm["_fact"]; asm["_fact"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__fact.apply(null, arguments);
};
...
var _fact = Module["_fact"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_fact"].apply(null, arguments) };
